            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800">Tabel Behavior</h1>


                        <!-- DataTales Example -->
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <form action="tambahbehavior.php" method="POST">
                                        ...
                                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            <thead class="table-primary">
                                                <tr>
                                                    ...
                                                    <th style="text-align: center; vertical-align: middle;">Judul Behavior
                                                    </th>
                                                    <th style="text-align: center; vertical-align: middle;">Isi Behavior
                                                    </th>
                                            ...
                                            $no = 1;
                                            include 'koneksi.php';
                                            $data = mysqli_query($koneksi, "SELECT * FROM tb_behavior");
                                            while ($d = mysqli_fetch_array($data)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <a href="editbehavior.php?id_behavior=<?php echo $d['id_behavior'] ?>"
                                                        class="btn btn-success" style="margin-bottom: 10px">Edit</a>
                                                    <a href="hbehavior.php?id_behavior=<?php echo $d['id_behavior'] ?>"
