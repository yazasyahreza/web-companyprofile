                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <form method="POST" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-3">
                                        <label for="inputPassword3" class="col-sm-2 col-form-label">Nama Perusahaan
                                            :</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="row mb-3">
                                        <label for="inputPassword3" class="col-sm-2 col-form-label">Logo Perusahaan
                                            :</label>
                                        <div class="col-sm-10">
...
if (isset($_POST['tambah'])) {
    ...
    $d = mysqli_query($koneksi, "INSERT INTO tb_biodata (nama_perusahaan, telepon, alamat, nama_pimpinan, logo_perusahaan, visi, misi, id_user) VALUE('$nama_perusahaan', '$telepon', '$alamat', '$nama_pimpinan', '$logo_perusahaan', '$visi', '$misi', '$id_user')");
