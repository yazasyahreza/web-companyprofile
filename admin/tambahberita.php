                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card-header py-3">
                            <h1 class="h3 mb-2 text-gray-800">Tambah Data Berita 
                                <?php 
                                    echo $no++;
                                ?>
                            </h1>
...
if (isset($_POST['tambah'])) {
    ...
    for ($i = 0; $i < $jum; $i++) {
        ...
        $d = mysqli_query($koneksi, "INSERT INTO tb_berita (judul, tgl_post, id_user, isi_berita, gambar) VALUE('$judul[$i]', '$tgl_post[$i]', '$id_user', '$isi_berita[$i]', '$gambar')");
    }
